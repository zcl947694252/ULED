...
public class RgbBatchGroupActivity extends TelinkMeshErrorDealActivity
    ...
    private void guideStep1() {
        guideShowCurrentPage = !GuideUtils.INSTANCE.getCurrentViewIsEnd(this,
                GuideUtils.INSTANCE.getEND_INSTALL_LIGHT_KEY(), false);
        if (guideShowCurrentPage) {
            GuideUtils.INSTANCE.resetDeviceScanningGuide(this);
            LinearLayout guide1 = addGroupLayout;
            GuideUtils.INSTANCE.guideBuilder(this,
                    GuideUtils.INSTANCE.getSTEP3_GUIDE_CREATE_GROUP())
                    .addGuidePage(GuideUtils.INSTANCE.addGuidePage(guide1,
                            R.layout.view_guide_scan1, getString(R.string.scan_light_guide_1),
                            v -> {
                                isGuide = true;
                                // addNewGroup();
                                popMain.showAtLocation(getWindow().getDecorView(), Gravity.CENTER
                                        , 0, 0);
    ...
    private void guideStep2() {
        ...
        if (guideShowCurrentPage) {
            ...
            GuideUtils.INSTANCE.guideBuilder(this,
                    GuideUtils.INSTANCE.getSTEP4_GUIDE_SELECT_GROUP())
                    .addGuidePage(GuideUtils.INSTANCE.addGuidePage(guide2,
                            R.layout.view_guide_scan1, getString(R.string.scan_light_guide_2),
                            v -> {
                                guideStep3();
                            }, GuideUtils.INSTANCE.getEND_INSTALL_LIGHT_KEY(), this))
                    .show();
    ...
    private void guideStep3() {
        ...
        if (guideShowCurrentPage) {
            ...
            GuideUtils.INSTANCE.guideBuilder(this,
                    GuideUtils.INSTANCE.getSTEP5_GUIDE_SELECT_SOME_LIGHT())
                    .addGuidePage(GuideUtils.INSTANCE.addGuidePage(guide3,
                            R.layout.view_guide_scan2, getString(R.string.scan_light_guide_3)
                            , v -> {
                                listDevices.performItemClick(guide3, 0,
                                        listDevices.getItemIdAtPosition(0));
                                guideStep4();
                            }, GuideUtils.INSTANCE.getEND_INSTALL_LIGHT_KEY(), this))
                    .show();
        }
    ...
    private void guideStep4() {
        ...
        if (guideShowCurrentPage) {
            ...
            GuideUtils.INSTANCE.guideBuilder(this, GuideUtils.INSTANCE.getSTEP6_GUIDE_SURE_GROUP())
                    .addGuidePage(GuideUtils.INSTANCE.addGuidePage(guide4,
                            R.layout.view_guide_scan3, getString(R.string.scan_light_guide_4),
                            v -> {
                                guide4.performClick();
                                GuideUtils.INSTANCE.changeCurrentViewIsEnd(this,
                                        GuideUtils.INSTANCE.getEND_INSTALL_LIGHT_KEY(), true);
                            }, GuideUtils.INSTANCE.getEND_INSTALL_LIGHT_KEY(), this))
                    .show();
        }
        //        sureGroups
