...
public final class NormalGroupSettingActivity extends TelinkBaseActivity {

    private ImageView backView;
    private NormalGroupSettingFragment settingFragment;
...
//		this.requestWindowFeature(Window.FEATURE_NO_TITLE);
        ...
        this.settingFragment = (NormalGroupSettingFragment) this.getSupportFragmentManager()
