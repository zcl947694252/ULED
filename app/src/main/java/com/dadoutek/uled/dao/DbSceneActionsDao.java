...
public class DbSceneActionsDao extends AbstractDao<DbSceneActions, Long> {
    ...
    private Query<DbSceneActions> dbScene_DbSceneActionsQuery;
    ...
    /** Internal query to resolve the "dbSceneActions" to-many relationship of DbScene. */
    public List<DbSceneActions> _queryDbScene_DbSceneActions(Long actionId) {
        synchronized (this) {
            if (dbScene_DbSceneActionsQuery == null) {
                QueryBuilder<DbSceneActions> queryBuilder = queryBuilder();
                queryBuilder.where(Properties.ActionId.eq(null));
                dbScene_DbSceneActionsQuery = queryBuilder.build();
            }
        }
        Query<DbSceneActions> query = dbScene_DbSceneActionsQuery.forCurrentThread();
