...
//    }
    ...
    public void lazyLoad(int showTypeView) {
        ImageView guide1= (ImageView) toolbar.findViewById(R.id.img_function1);
        ImageView guide2= (ImageView) toolbar.findViewById(R.id.img_function2);
                builder.addGuidePage(GuideUtils.INSTANCE.addGuidePage(guide1,R.layout.view_guide_simple_scene1,getString(R.string.scene_guide_1)))
                .addGuidePage(GuideUtils.INSTANCE.addGuidePage(guide2,R.layout.view_guide_simple_scene1,getString(R.string.scene_guide_2)));
        ...
        if (adaper.getItemCount() != 0 && showTypeView==1) {
            ...
            builder.addGuidePage(GuideUtils.INSTANCE.addGuidePage(guide3,R.layout.view_guide_simple_scene2,getString(R.string.scene_guide_3)))
                    .addGuidePage(GuideUtils.INSTANCE.addGuidePage(guide4,R.layout.view_guide_simple_scene2,getString(R.string.scene_guide_4)));
            ...
            GuideUtils.INSTANCE.guideBuilder(this,Constant.TAG_SceneFragment1)
                    .addGuidePage(GuideUtils.INSTANCE.addGuidePage(guide3,R.layout.view_guide_simple_scene2,getString(R.string.scene_guide_3)))
                    .addGuidePage(GuideUtils.INSTANCE.addGuidePage(guide4,R.layout.view_guide_simple_scene2,getString(R.string.scene_guide_4)))
                    .show();
        }
    }
