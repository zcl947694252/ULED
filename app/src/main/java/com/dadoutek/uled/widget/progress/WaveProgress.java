...
public class WaveProgress extends View {
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        TypedArray typedArray = context.obtainStyledAttributes(attrs, com.littlejie.circleprogress.R.styleable.WaveProgress);

        antiAlias = typedArray.getBoolean(com.littlejie.circleprogress.R.styleable.WaveProgress_antiAlias, true);
        mDarkWaveAnimTime = typedArray.getInt(com.littlejie.circleprogress.R.styleable.WaveProgress_darkWaveAnimTime, Constant.DEFAULT_ANIM_TIME);
        mLightWaveAnimTime = typedArray.getInt(com.littlejie.circleprogress.R.styleable.WaveProgress_lightWaveAnimTime, Constant.DEFAULT_ANIM_TIME);
        mMaxValue = typedArray.getFloat(com.littlejie.circleprogress.R.styleable.WaveProgress_maxValue, Constant.DEFAULT_MAX_VALUE);
        mValue = typedArray.getFloat(com.littlejie.circleprogress.R.styleable.WaveProgress_value, Constant.DEFAULT_VALUE);
        mValueSize = typedArray.getDimension(com.littlejie.circleprogress.R.styleable.WaveProgress_valueSize, Constant.DEFAULT_VALUE_SIZE);
        mValueColor = typedArray.getColor(com.littlejie.circleprogress.R.styleable.WaveProgress_valueColor, Color.BLACK);

        mHint = typedArray.getString(com.littlejie.circleprogress.R.styleable.WaveProgress_hint);
        mHintColor = typedArray.getColor(com.littlejie.circleprogress.R.styleable.WaveProgress_hintColor, Color.BLACK);
        mHintSize = typedArray.getDimension(com.littlejie.circleprogress.R.styleable.WaveProgress_hintSize, Constant.DEFAULT_HINT_SIZE);

        mCircleWidth = typedArray.getDimension(com.littlejie.circleprogress.R.styleable.WaveProgress_circleWidth, Constant.DEFAULT_ARC_WIDTH);
        mCircleColor = typedArray.getColor(com.littlejie.circleprogress.R.styleable.WaveProgress_circleColor, Color.GREEN);
        mBgCircleColor = typedArray.getColor(com.littlejie.circleprogress.R.styleable.WaveProgress_bgCircleColor, Color.WHITE);

        mWaveHeight = typedArray.getDimension(com.littlejie.circleprogress.R.styleable.WaveProgress_waveHeight, Constant.DEFAULT_WAVE_HEIGHT);
        mWaveNum = typedArray.getInt(com.littlejie.circleprogress.R.styleable.WaveProgress_waveNum, 1);
        mDarkWaveColor = typedArray.getColor(com.littlejie.circleprogress.R.styleable.WaveProgress_darkWaveColor,
                getResources().getColor(android.R.color.holo_blue_dark));
        mLightWaveColor = typedArray.getColor(com.littlejie.circleprogress.R.styleable.WaveProgress_lightWaveColor,
                getResources().getColor(android.R.color.holo_green_light));

        isR2L = typedArray.getInt(com.littlejie.circleprogress.R.styleable.WaveProgress_lightWaveDirect, R2L) == R2L;
        lockWave = typedArray.getBoolean(com.littlejie.circleprogress.R.styleable.WaveProgress_lockWave, false);
