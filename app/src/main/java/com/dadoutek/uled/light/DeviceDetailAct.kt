...
//        deviceType = this.intent.extras!!.getInt(Constant.DEVICE_TYPE)
...
//                        lightList = DBUtils.getAllNormalLight()
//                    }
//                    Constant.INSTALL_RGB_LIGHT -> {
//                        lightList = DBUtils.getAllRGBLight()
//                    }
//                    Constant.INSTALL_SWITCH -> {
//                        lightList = DBUtils.getAllSwitch()
//                    }
//                    Constant.INSTALL_SENSOR -> {
//                        lightList = DBUtils.getAllSensor()
//                    }
//                    Constant.INSTALL_CURTAIN -> {
//                        lightList = DBUtils.getAllCurtain()
//                    }
//                }
//        deviceName=installList[deviceType].deviceType
//    }
//
...
//        toolbar.title = deviceName + " (" + lightList.size + ")"
//
...
//                intent.putExtra(Constant.GROUP_ARESS_KEY, DBUtils.getGroupByID(currentLight!!.belongGroupId))
