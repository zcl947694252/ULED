 ...
 * 更新描述
 */
class GroupOTASensorAdapter(resId: Int, data: MutableList<DbSensor>) : BaseQuickAdapter<DbSensor, BaseViewHolder>(resId, data) {
    override fun convert(helper: BaseViewHolder, item: DbSensor?) {
        ...
        //groupName.text = StringUtils.getSensorGroupName(item)
