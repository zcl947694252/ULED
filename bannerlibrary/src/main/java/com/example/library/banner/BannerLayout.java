...
public class BannerLayout extends FrameLayout {
    ...
    private OnBanneChangeListener changeListener;
    ...
    public void setAdapter(RecyclerView.Adapter adapter) {
        ...
        mRecyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
                ...
                changeListener.onItemChange(currentIndex);
    ...
    public void setOnBannerItemChangeListener(OnBanneChangeListener changeListener) {
        this.changeListener = changeListener;
    }

    public interface OnBanneChangeListener {
