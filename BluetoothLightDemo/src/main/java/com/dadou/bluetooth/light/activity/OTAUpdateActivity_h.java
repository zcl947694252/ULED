...
import com.dadou.bluetooth.light.model.OtaDevice;
 ...
 */
public class OTAUpdateActivity_h extends TelinkMeshErrorDealActivity implements EventListener<String>, View.OnClickListener {
...
//                        log("version: " + version + " -- light version:" + light.version + " --mode: " + this.mode);
            ...
            if (progress == 100) {
                ...
                mesh.otaDevice = null;
                mesh.saveOrUpdate(OTAUpdateActivity_h.this);
                sendGetVersionCommand();
            }
...
//                log("ota progress :" + deviceInfo.progress + "%");
    ...
    private void parseFile() {
        ...
        if (mFileVersion == null || mFileVersion.charAt(0) != 'V') {
